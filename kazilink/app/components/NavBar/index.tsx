...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 bg-[#fffaf4] shadow-sm z-50">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex items-center space-x-6 text-xl">
          <a href="#" className="text-[#3D1700] hover:text-[#E0B15E]">Home</a>
          <a href="#" className="text-[#3D1700] hover:text-[#E0B15E]">How It Works</a>
          <a href="#" className="text-[#3D1700] hover:text-[#E0B15E]">Features</a>
          <a href="#" className="text-[#3D1700] hover:text-[#E0B15E]">Contact</a>
        </div>
        <button
